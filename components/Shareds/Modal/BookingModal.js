...
const BookingModal = ({ setBookingModalOpen }) => {
  ...
  return (
    <div
      className="fixed w-full h-full top-0 bg-gray-400/70  overflow-y-auto scrollbar-thin  scrollbar-thumb-orange-500  scrollbar-rounded-full"
      style={{ zIndex: "99" }}
    >
      <div className="flex items-center h-full">
        <div className="max-w-3xl bg-white grid grid-cols-6  m-auto ">
